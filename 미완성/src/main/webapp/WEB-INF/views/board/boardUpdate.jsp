...
<table class = "table table-hover" style="margin-left: auto; margin-right: auto; width : 850px;">
  ...
  <tbody>
	...
	<tr>
		<td scope = "row">게시물 번호</td>
		<td scope = "row"><input type = "text" class = "form-control"  rows = "3" name = "code" value = ${boardVo.code }></td>
	</tr>
	<tr>
		<td scope = "row">제목</td>
	...
	<tr>
		...
		<td><input type = "date" class = "form-control"  rows = "3"  name = "g_reserveStartnDate"></td>
	</tr>
	<tr>
		<td>숙소로 쓸수있는 기간 [끝]</td>
		<td><input type = "date" class = "form-control"  rows = "3"  name = "g_reserveEndnDate"></td>
	</tr>
	<tr>
		<td>가격</td>
