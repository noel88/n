...
<form action= "update" method="get">
   ...
   <table style = "margin-left : auto; margin-right : auto; margin-top : 30px; width: 50%;">
      ...
      <input type="text" class="form-control" name = "title" id="exampleInputPassword1" placeholder="Title" value="${postVO.title}">
   	  <input type="hidden" class="form-control" name = "post_no" value="${postVO.post_no}">
	...
	<tr>
		...
		<hr>
		<br>
	      <textarea class="editable" rows="70" name = "context">${postVO.context}</textarea>
	    </div>
		</td>
