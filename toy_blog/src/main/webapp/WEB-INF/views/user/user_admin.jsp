...
<style>
*{box-sizing:border-box; -moz-box-sizing:border-box; -webkit-box-sizing:border-box;}body{background: #f0f0f0;}.content{width: 260px; margin: 20px auto;}.colors{width: 260px; float: left; margin: 20px auto;}.colors a{width: 43.3px; height: 30px; float: left;}.colors .default{background: #414956;}.colors .blue{background: #4A89DC;}.colors .green{background: #03A678;}.colors .red{background: #ED5565;}.colors .white{background: #fff;}.colors .black{background: #292929;}
...
<div class="content" style="float: left; margin-right: 20px; margin-bottom: 100px;">
			<div class="colors">
			...
			<div id="jquery-accordion-menu" class="jquery-accordion-menu">
				<div class="jquery-accordion-menu-header">블로그관리 홈</div>
				<ul>
					<li class="active"><a href="#"><i class="fa fa-home"></i>콘텐츠</a></li>
					<li><a href="#">글 관리</a></li>
					<li><a href="#">페이지관리</a>
					<li><a href="#">카테고리관리</a>
					<li><a href="#">공지관리</a>
					<li><a href="#">서식관리</a>
					<li><a href="#">설정</a>
					<li class="active"><a href="#"><i class="fa fa-home"></i>댓글.방명록</a></li>
					<li><a href="#">댓글 관리</a></li>
					<li><a href="#">방명록 관리</a>
					<li><a href="#">설정</a>
					<li class="active"><a href="#"><i class="fa fa-home"></i>통계</a></li>
					<li><a href="#">방문자</a></li>
					<li><a href="#">키워드</a>
					<li><a href="#">경로</a>
					<li class="active"><a href="#"><i class="fa fa-home"></i>꾸미기</a></li>
					<li><a href="#">스킨변경</a></li>
					<li><a href="#">스킨편집</a>
					<li><a href="#">사이드바</a>
					<li><a href="#">메뉴</a>
...
<div style="float: left; margin-top: 50px;">
		<div><h2>2018년 10월 30일 통계</h2></div>
			<table class ="table" border="1" style="margin-left: auto; margin-right: auto; width: 100%; margin-bottom: 30px;">
				<tr>
					<td>오늘 방문자 수</td>
					<td>어제 방문자 수</td>
					<td>주간 방문자 수</td>
				...
				<tr>
					<td colspan="4">그래프가 들어갑니다.</td>
				</tr>
				<tr>
					<td> 유입키워드 순위 </td>
					<td colspan="3"> 최근 유입경로 </td>
				</tr>
				<tr>
					<td> 유입된 키워드가 없습니다. </td>
					<td colspan="3"> 유입된 경로가 없습니다. </td>
				</tr>
			</table>
